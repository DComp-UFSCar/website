    ...
    <body>
        ...
        <section id='corpo'>
            <div id='blocoFrom'>
                ...
                <form class="formBloco" id="formulario" method="POST" action="../dao/SeditarPagina.php">
                <span class="nameForm"><b>Editar Página de disciplina.</b></span>
                ...
                <div class="linhaForm">
                    ...
                    <select id="disciplinaDb" class="inputForm select" name="codMat">
                       <?php 
                            foreach ($_SESSION['listaDeMaterias'] as $perfil => $materia) {
                                echo '<optgroup label="Perfil '.$perfil.'">';
                                    foreach($materia as $linha){
                                        echo '<option value="'.$linha['cod'].'"';
                                        if($linha['cod'] == $_SESSION['pagina']['codMat']){
                                            echo  ' selected="selected" ';
                                        }
                                        echo ' >'.$linha['codDisciplina'].'</option>';
                                    }
                                    echo '</optgroup>';
                            }
                        ?>
                ...
                <div class="linhaForm">
                    ...
                    <input class="inputForm textoImput" name="titulo" id="titulo" type="text" value="<?php echo $_SESSION['pagina']['titulo']; ?>">
                </div>  
                <div class="linhaForm">
                ...
                <div class="fromTextArea">
                    <textarea name="pagina"><?php echo $_SESSION['pagina']['pagina']; ?></textarea>
                </div>  
