    ...
    <body>
        ...
        <section id='corpo'>
            <div id='blocoFrom'>
                ...
                <form class="formBloco" id="formulario" method="POST" action="../dao/SeditarNoticia.php">
                <span class="nameForm"><b>Editar Notícia.</b></span>
                ...
                <div class="fromTextArea">
                    <textarea name="noticia"><?php echo $_SESSION['noticia']['texto']; ?></textarea>
                </div>  
