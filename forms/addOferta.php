        ...
        <section id='corpo'>
            ...
            <form id="formulario" class="formBloco" method="POST" action="../dao/addOferta.php">
                ...
                <div class="linhaForm">
                    ...
                    <select id="profBd" class="inputForm texto select" name="codProf">
                        <option value="">Selecione</option>
                        <?php
...
jQuery.validator.addClassRules('horario', {
        required: true
    });
jQuery.validator.addClassRules('local', {
        required: true
    });
//jQuery.validator.addClassMessages('horario', {
//        required: "Digite um Horário"
//});
//$(".horario").rules("add", { 
//  required:true 
//});
//$(".horario").messages("add", { 
//  required: "Digite um Horário"
//});
