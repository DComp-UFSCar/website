...
| -------------------------------------------------------------------*/
	...
	$config['upload_path'] = $_SERVER['SCRIPT_FILENAME']; // Physical path. [Usually works fine like this]
        $config['upload_path'] = str_replace("/js/plugins/jbimages/ci/index.php", '/uploads', $config['upload_path']);
